...
class CheckMediaResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["have_trash", b"have_trash", "missing", b"missing", "missing_media_notes", b"missing_media_notes", "report", b"report", "unused", b"unused"]) -> None: ...
...
class TrashMediaFilesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["fnames", b"fnames"]) -> None: ...
...
class AddMediaFileRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "desired_name", b"desired_name"]) -> None: ...
