...
class SchedTimingTodayLegacyRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_created_mins_west", b"_created_mins_west", "created_mins_west", b"created_mins_west"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_created_mins_west", b"_created_mins_west", "created_mins_west", b"created_mins_west", "created_secs", b"created_secs", "now_mins_west", b"now_mins_west", "now_secs", b"now_secs", "rollover_hour", b"rollover_hour"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_created_mins_west", b"_created_mins_west"]) -> typing.Literal["created_mins_west"] | None: ...
...
class SqlValue(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["Data", b"Data", "blobValue", b"blobValue", "doubleValue", b"doubleValue", "longValue", b"longValue", "stringValue", b"stringValue"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["Data", b"Data", "blobValue", b"blobValue", "doubleValue", b"doubleValue", "longValue", b"longValue", "stringValue", b"stringValue"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["Data", b"Data"]) -> typing.Literal["stringValue", "longValue", "doubleValue", "blobValue"] | None: ...
...
class DbResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["result", b"result", "rowCount", b"rowCount", "sequenceNumber", b"sequenceNumber", "startIndex", b"startIndex"]) -> None: ...
...
class GetNextResultPageRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["index", b"index", "sequence", b"sequence"]) -> None: ...
