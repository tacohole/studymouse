...
class CardStatsResponse(google.protobuf.message.Message):
    ...
    FSRS_PARAMS_FIELD_NUMBER: builtins.int
    ...
    def memory_state(self) -> anki.cards_pb2.FsrsMemoryState: ...
    @property
    def fsrs_params(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]: ...
    def __init__(
        self,
        *,
        ...
        fsrs_params: collections.abc.Iterable[builtins.float] | None = ...,
    ) -> None: ...
