...
class SyncAuth(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_endpoint", b"_endpoint", "_io_timeout_secs", b"_io_timeout_secs", "endpoint", b"endpoint", "io_timeout_secs", b"io_timeout_secs"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_endpoint", b"_endpoint", "_io_timeout_secs", b"_io_timeout_secs", "endpoint", b"endpoint", "hkey", b"hkey", "io_timeout_secs", b"io_timeout_secs"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_endpoint", b"_endpoint"]) -> typing.Literal["endpoint"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_io_timeout_secs", b"_io_timeout_secs"]) -> typing.Literal["io_timeout_secs"] | None: ...
...
class SyncLoginRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_endpoint", b"_endpoint", "endpoint", b"endpoint"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_endpoint", b"_endpoint", "endpoint", b"endpoint", "password", b"password", "username", b"username"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_endpoint", b"_endpoint"]) -> typing.Literal["endpoint"] | None: ...
...
class SyncStatusResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_new_endpoint", b"_new_endpoint", "new_endpoint", b"new_endpoint"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_new_endpoint", b"_new_endpoint", "new_endpoint", b"new_endpoint", "required", b"required"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_new_endpoint", b"_new_endpoint"]) -> typing.Literal["new_endpoint"] | None: ...
...
class SyncCollectionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["auth", b"auth", "sync_media", b"sync_media"]) -> None: ...
...
class SyncCollectionResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_new_endpoint", b"_new_endpoint", "new_endpoint", b"new_endpoint"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_new_endpoint", b"_new_endpoint", "host_number", b"host_number", "new_endpoint", b"new_endpoint", "required", b"required", "server_media_usn", b"server_media_usn", "server_message", b"server_message"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_new_endpoint", b"_new_endpoint"]) -> typing.Literal["new_endpoint"] | None: ...
...
class MediaSyncStatusResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["active", b"active", "progress", b"progress"]) -> None: ...
...
class MediaSyncProgress(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["added", b"added", "checked", b"checked", "removed", b"removed"]) -> None: ...
...
class FullUploadOrDownloadRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_server_usn", b"_server_usn", "auth", b"auth", "server_usn", b"server_usn"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_server_usn", b"_server_usn", "auth", b"auth", "server_usn", b"server_usn", "upload", b"upload"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_server_usn", b"_server_usn"]) -> typing.Literal["server_usn"] | None: ...
