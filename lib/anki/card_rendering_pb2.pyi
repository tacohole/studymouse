...
class RenderCardResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["answer_nodes", b"answer_nodes", "css", b"css", "is_empty", b"is_empty", "latex_svg", b"latex_svg", "question_nodes", b"question_nodes"]) -> None: ...
