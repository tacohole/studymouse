...
@typing.final
class GetClozeFieldOrdsResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    ORDS_FIELD_NUMBER: builtins.int
    @property
    def ords(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]: ...
    def __init__(
        self,
        *,
        ords: collections.abc.Iterable[builtins.int] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["ords", b"ords"]) -> None: ...

global___GetClozeFieldOrdsResponse = GetClozeFieldOrdsResponse
