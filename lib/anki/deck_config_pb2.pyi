...
@typing.final
class GetRetentionWorkloadRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    search: builtins.str
    @property
    def w(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]: ...
    def __init__(
        self,
        *,
        w: collections.abc.Iterable[builtins.float] | None = ...,
        search: builtins.str = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["search", b"search", "w", b"w"]) -> None: ...

global___GetRetentionWorkloadRequest = GetRetentionWorkloadRequest

@typing.final
class GetRetentionWorkloadResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    @property
    def costs(self) -> google.protobuf.internal.containers.ScalarMap[builtins.int, builtins.float]: ...
    def __init__(
        self,
        *,
        costs: collections.abc.Mapping[builtins.int, builtins.float] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["costs", b"costs"]) -> None: ...

global___GetRetentionWorkloadResponse = GetRetentionWorkloadResponse
...
class DeckConfigsForUpdate(google.protobuf.message.Message):
    ...
    class CurrentDeck(google.protobuf.message.Message):
        ...
        class Limits(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing.Literal["_desired_retention", b"_desired_retention", "_new", b"_new", "_new_today", b"_new_today", "_review", b"_review", "_review_today", b"_review_today", "desired_retention", b"desired_retention", "new", b"new", "new_today", b"new_today", "review", b"review", "review_today", b"review_today"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["_desired_retention", b"_desired_retention", "_new", b"_new", "_new_today", b"_new_today", "_review", b"_review", "_review_today", b"_review_today", "desired_retention", b"desired_retention", "new", b"new", "new_today", b"new_today", "new_today_active", b"new_today_active", "review", b"review", "review_today", b"review_today", "review_today_active", b"review_today_active"]) -> None: ...
            @typing.overload
    ...
    FSRS_HEALTH_CHECK_FIELD_NUMBER: builtins.int
    FSRS_LEGACY_EVALUATE_FIELD_NUMBER: builtins.int
    ...
    """only applies to v3 scheduler"""
    fsrs: builtins.bool
    fsrs_health_check: builtins.bool
    fsrs_legacy_evaluate: builtins.bool
...
class UpdateDeckConfigsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["limits", b"limits"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["apply_all_parent_limits", b"apply_all_parent_limits", "card_state_customizer", b"card_state_customizer", "configs", b"configs", "fsrs", b"fsrs", "fsrs_health_check", b"fsrs_health_check", "fsrs_reschedule", b"fsrs_reschedule", "limits", b"limits", "mode", b"mode", "new_cards_ignore_review_limit", b"new_cards_ignore_review_limit", "removed_config_ids", b"removed_config_ids", "target_deck_id", b"target_deck_id"]) -> None: ...
